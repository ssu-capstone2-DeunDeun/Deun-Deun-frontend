	...
	return (
		<Container>
			...
			<IconContainer>
				{checkLogin === false ? (
					<div className="sign">
						<div className="signBtn" onClick={() => popupMake()}>
							로그인
						</div>
					</div>
				) : (
					<div className="signout">
						...
						<div className="signBtn signBtnLogout" onClick={onLogout}>
							로그아웃
						</div>
						...
						<div className="logo">
							...
							<GoogleContainer>
								<a href={GOOGLE_AUTH_URL}>
									...
									<div className="googleText">GOOGLE 계정으로 로그인 하기</div>
								</a>
							</GoogleContainer>
							<NaverContainer>
								<a href={NAVER_AUTH_URL}>
									...
									<div className="naverText">NAVER 계정으로 로그인 하기</div>
								</a>
							</NaverContainer>
						</div>
					</LoginModal>
