	...
	return (
		...
		>
			<div className="recruitNoticeBox">
				{number !== index ? <ImCheckboxUnchecked /> : <ImCheckboxChecked />}
			...
			<ContentBlock>
				<div className="main">
					...
					<div className="mainContent">
						<div className="mainContentHeader">
							...
							<div className="func">
								<div className="viewAll">
									...
									<DropdownMenu options={view} selectedIndex={viewIndex} setSelectedIndex={setViewIndex} />
								</div>
						...
						{applicants &&
							applicants.map((applicant) => <ApplicantInfo clubName={clubName} id={applicant} applicant={applicant} />)}
					</div>
				</div>
			</ContentBlock>
				...
				<div id="msgPopup" className="delete">
					...
					<div className="receiverIist">
						{sendMsgLists.map((sendMsgList) => (
							<button id={sendMsgList}>{sendMsgList}</button>
						))}
					</div>
					<div className="content">
						<div>내용</div>
