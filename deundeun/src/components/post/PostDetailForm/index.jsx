	...
	return (
		<div>
			{comments.map((comment) => (
				<CommentListItem id={comment} comment={comment} />
			))}
		</div>
	);
};
			...
			<div className="item">
				<div>
					...
					<div className="itemContent">
						{click === true ? content : content.length > 70 ? `${content.slice(0, 70)}...` : content}
					</div>
				</div>
			</div>
			<div className="btn">
...
const PostDetailForm = ({ history, postData, postLike, onClickHeart, onChangeInput, commentValue }) => {
	...
	const contents = {
		...
		postDetailTitle: '센터는 지효인가? 나연인가?',
		nickname: '안동핵주먹',
		publishedDate: '2021.01.01 12:12',
		likesNum: 1234,
		views: 4000,
		content:
		...
		nextPostTitle: '제목,제목,제목,제목,제목,제목',
		beforePostTitle: '제목,제목,제목,제목,제목,제목',
		comments: [
			{
				writer: '헬스왕김상록',
				publishedDate: '2021.01.01 12:12',
				content:
					'프리웨이트 짱짱맨!! 아주 좋아용프리웨이트 짱짱맨!! 먼저 가벼운 스트레칭과 맨손체조 등으로 준비 운동을 하는 것이 좋습니다. 뻣뻣해진 관절을 늘려주는 준비 운동을 통해 근육의 온도 및 체온을 높이고 관절의 부상과 근육 결림을 예방할 수 있습니다.아주 좋아용프리웨이트 짱짱맨!! 아주 좋아용프리웨이트 짱짱맨!! 아주 좋아용프리웨이트 짱짱맨!! 아주 좋아용프리웨이트 짱짱맨!! 아주 좋아용 '
			},
			{
				writer: '3대 500',
				publishedDate: '2021.01.01 12:12',
				content:
					'프리웨이트 짱짱맨!! 아주 좋아용먼저 가벼운 스트레칭과 맨손체조 등으로 준비 운동을 하는 것이 좋습니다. 뻣뻣해진 관절을 늘려주는 준비 운동을 통해 근육의 온도 및 체온을 높이고 관절의 부상과 근육 결림을 예방할 수 있습니다. '
			},
			{
				writer: '헬스천재김상록',
				publishedDate: '2021.01.01 12:12',
				content:
					'프먼저 가벼운 스트레칭과 맨손체조 등으로 준비 운동을 하는 것이 좋습니다. 뻣뻣해진 관절을 늘려주는 준비 운동을 통해 근육의 온도먼저 가벼운 스트레칭과 맨손체조 등으로 준비 운동을 하는 것이 좋습니다. 뻣뻣해진 관절을 늘려주는 준비 운동을 통해 근육의 온도 및 체온을 높이고 관절의 부상과 근육 결림을 예방할 수 있습니다. 및 체온을 높이고 관절의 부상과 근육 결림을 예방할 수 있습니다.리웨이트 짱짱맨!! 아주 좋아용'
			},
			{
				writer: '방구석헬창',
				publishedDate: '2021.01.01 12:12',
				content:
					'프리웨이트먼저 가벼운 스트레칭과 맨손체조 등으로 준비 운동을 하는 것이 좋습니다. 뻣뻣해진 관절을 늘려주는 준비 운동을 통해 근육의 온도 및 체온을 높이고 관절의 부상과 근육 결림을 예방할 수 있습니다. 짱짱맨!! 아주 좋아용 '
			},
			{
				writer: '헬스isNo.1',
				publishedDate: '2021.01.01 12:12',
				content:
					'프리웨이트 짱짱맨먼저 가벼운 스트레칭과 맨손체조 등으로 준비 운동을 하는 것이 좋습니다. 뻣뻣해진 관절을 늘려주는 준비 운동을 통해 근육의 온도 및 체온을 높이고 관절의 부상과 근육 결림을 예방할 수 있습니다.!! 아주 좋아용 '
			}
		]
	};
				...
				<div className="headerContent">
					...
					<div className="info">
						...
						<div className="function">
							...
							<div className={postLike && postLike.like ? 'heart' : 'unheart'} onClick={onClickHeart}>
								<FavoriteBorderIcon />
							</div>
					...
					<div>
						...
						{postData && postData.afterPost ? (
							<div
								className="listTitle"
								onClick={() =>
									history.push(`/club/${postData.afterPost.club.clubName}/post/${postData.afterPost.postId}`)
								}
							>
								{postData.afterPost.title}
							</div>
						) : (
							<div className="listTitle">다음 글이 존재하지 않습니다.</div>
						)}
					</div>
					<div>
						...
						{postData && postData.beforePost ? (
							<div
								className="listTitle"
								onClick={() =>
									history.push(`/club/${postData.beforePost.club.clubName}/post/${postData.beforePost.postId}`)
								}
							>
								{postData.beforePost.title}
							</div>
						) : (
							<div className="listTitle">이전 글이 존재하지 않습니다.</div>
						)}
					</div>
				</div>
			</div>
